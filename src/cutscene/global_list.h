...
#define VAR_POS_fire_trials_boss_dead 0
#define VAR_TYP_fire_trials_boss_dead DATA_TYPE_BOOL
#define VAR_LOC_fire_trials_boss_dead (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 0}

#define VAR_POS_fire_trials_bossdoor_kiln_0 1
#define VAR_TYP_fire_trials_bossdoor_kiln_0 DATA_TYPE_BOOL
#define VAR_LOC_fire_trials_bossdoor_kiln_0 (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 1}

#define VAR_POS_fire_trials_bossdoor_kiln_1 2
#define VAR_TYP_fire_trials_bossdoor_kiln_1 DATA_TYPE_BOOL
#define VAR_LOC_fire_trials_bossdoor_kiln_1 (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 2}

#define VAR_POS_fire_trials_bossdoor_open 3
#define VAR_TYP_fire_trials_bossdoor_open DATA_TYPE_BOOL
#define VAR_LOC_fire_trials_bossdoor_open (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 3}

#define VAR_POS_fire_trials_key_0 4
#define VAR_TYP_fire_trials_key_0 DATA_TYPE_BOOL
#define VAR_LOC_fire_trials_key_0 (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 4}

#define VAR_POS_fire_trials_key_1 5
#define VAR_TYP_fire_trials_key_1 DATA_TYPE_BOOL
#define VAR_LOC_fire_trials_key_1 (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 5}

#define VAR_POS_fire_trials_key_2 6
#define VAR_TYP_fire_trials_key_2 DATA_TYPE_BOOL
#define VAR_LOC_fire_trials_key_2 (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 6}

#define VAR_POS_has_entered_fire_trials 7
#define VAR_TYP_has_entered_fire_trials DATA_TYPE_BOOL
#define VAR_LOC_has_entered_fire_trials (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 7}

#define VAR_POS_has_staff_default 8
#define VAR_TYP_has_staff_default DATA_TYPE_BOOL
#define VAR_LOC_has_staff_default (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 8}

#define VAR_POS_has_talked_outside 9
#define VAR_TYP_has_talked_outside DATA_TYPE_BOOL
#define VAR_LOC_has_talked_outside (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 9}

#define VAR_POS_intro_played 10
#define VAR_TYP_intro_played DATA_TYPE_BOOL
#define VAR_LOC_intro_played (global_location_t){.data_type = DATA_TYPE_BOOL, .word_offset = 10}
