...
#define RSP_MENU_VIEWPORT 0x48
#define RSP_MENU_VERTEX_POINTS 0x50
#define RSP_MENU_NEXT_VERTEX 0x70
#define RSP_MENU_RDPQ_TRI_DATA0 0x80
#define RSP_MENU_RDPQ_TRI_DATA1 0xa0
#define RSP_MENU_RDPQ_TRI_DATA2 0xc0
